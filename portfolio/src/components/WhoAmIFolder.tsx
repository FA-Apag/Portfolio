  ...
  if (activePage) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-[4px] animate-in fade-in duration-300" onClick={onClose}>
        ...
        <div 
          className="relative w-full max-w-5xl h-[90vh] overflow-y-auto bg-transparent flex justify-center animate-in zoom-in-95 duration-300 rounded-xl scrollbar-hide"
